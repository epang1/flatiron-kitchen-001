  ...
  def create
    ...
    respond_to do |format|
      if @ingredient.save
        ...
        format.json { render json: @ingredient.errors, status: :undsaocessable_entity }
      end
    end
  end
  ...
  def update
    ...
    respond_to do |format|
      if @ingredient.update(ingredient_params)
        format.html { redirect_to @ingredient, notice: "#{@ingredient.name} was successfully updated." }
